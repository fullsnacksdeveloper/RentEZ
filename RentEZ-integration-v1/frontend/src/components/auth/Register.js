...
const Register = () => {
 ...
 // }, [clearError]);
  ...
  useEffect(() => {
  clearError();
}, []); // Clear once on mount (or unmount cleanup if needed)
  ...
  const wouldSendHeaders = {
    ...
    console.log('Body size:', bodyJson.length);
    console.log('Body content:', bodyJson);
    
    // Try the actual request
    console.log('=== MAKING REQUEST ===');
    
    const result = await register(bodyData);
