            ...
            <div className="flex flex-col space-y-3">
              ...
              {isAuthenticated ? (
                <>
                  ...
                  {user?.userType === 'landlord' && (
                    <>
                      <Link to="/landlord/create-listing" className="text-blue-600 font-medium" onClick={() => setIsMenuOpen(false)}>
                        Add Property
                      </Link>
                  ...
                  {user?.userType === 'tenant' && (
                    <>
                      <Link to="/applications" className="text-gray-700 hover:text-blue-600 transition-colors" onClick={() => setIsMenuOpen(false)}>
                        My Applications
                      </Link>
