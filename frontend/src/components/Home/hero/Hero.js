...
const Hero = () => {
  ...
  const recentListings = [
    { price: '$2,400', beds: 3, baths: 2, sqft: '1,200', image: propertyImages[0], city: 'Kingston' },
    { price: '$1,800', beds: 2, baths: 1, sqft: '900', image: propertyImages[1], city: 'Spanish Town' },
    { price: '$3,200', beds: 4, baths: 3, sqft: '1,800', image: propertyImages[2], city: 'Montego Bay' }
  ];
  ...
  // 👇 Only append filters if they're not default values
  if (searchFilters.city) searchParams.append('city', searchFilters.city);

  if (searchFilters.propertyType !== 'all') {
    searchParams.append('propertyType', searchFilters.propertyType);
  }

  if (searchFilters.priceRange !== 'any') {
    const [minRent, maxRent] = searchFilters.priceRange.split('-');
    searchParams.append('minRent', minRent);
    searchParams.append('maxRent', maxRent);
  }
            ...
            <div className='search-grid'>
              ...
              <div className='search-box'>
                ...
                <div className='input-content'>
                  ...
                  <select 
                    value={searchFilters.rental_type}
