...
const Login = () => {
  ...
  //const { user } = useAuth(); // Add this to get the user object
 ...
 /* useEffect(() => {
  ...
  if (isAuthenticated && user) {
    // If they were trying to access a protected route, send them there:
   ...
   /*if (isAuthenticated) {
    const userType = JSON.parse(localStorage.getItem('user'))?.userType;
      ...
      if (userType === 'landlord') {
        ...
        navigate('/dashboard', { replace: true }); // tenant by default
      }
    }
